...
CREATE TABLE TBL_RECORD_VIDEO_RECEIPT(
  ...
  TOTAL_PRICE_PER_VIDEO NUMBER NOT NULL,
...
COMMENT ON COLUMN TBL_RECORD_VIDEO_RECEIPT.RECEIPT_NO NUMBER IS '정산내역번호';
...
CREATE TABLE TBL_REALTIME_CLASS_RECEIPT(
  ...
  RECEIPT_NO NUMBER REFERENCES TBL_RECEIPT(RECEIPT_NO),
  TOTAL_PRICE_PER_EDITION NUMBER NOT NULL
);
...
COMMENT ON COLUMN TBL_RECEIPT.RECEIPT_DETAIL IS '원청징수세금';
