...
, CLASS_CATEGORY VARCHAR2(20 BYTE) NOT NULL 
, CLASS_INTRO VARCHAR2(50 BYTE) NOT NULL 
, CLASS_INTRODUCE VARCHAR2(100 BYTE) NOT NULL 
, CREATED_DATE VARCHAR2(30 BYTE) NOT NULL 
, CLASS_STATUS VARCHAR2(20 BYTE) DEFAULT 'N' 
, CLASS_APPROVAL VARCHAR2(20 BYTE) DEFAULT 'N' 
, CONSTRAINT TBL_CLASS_PK PRIMARY KEY 
  (
    CLASS_NO 
  )
  USING INDEX 
  (
      CREATE UNIQUE INDEX TBL_CLASS_PK ON TBL_CLASS (CLASS_NO ASC) 
      LOGGING 
      TABLESPACE SYSTEM 
      PCTFREE 10 
      INITRANS 2 
...
ADD CONSTRAINT TBL_CLASS_FK1 FOREIGN KEY
(
  ATTACHMENT_NO 
)
REFERENCES TBL_ATTACHMENT
(
  ATTACHMENT_NO 
)
ENABLE;
...
ALTER TABLE TBL_CLASS
ADD CONSTRAINT TBL_CLASS_FK2 FOREIGN KEY
(
  TRAINER_NO 
)
...
COMMENT ON COLUMN TBL_CLASS.CLASS_NO IS '개설수업번호';
COMMENT ON COLUMN TBL_CLASS.TRAINER_NO IS '트레이너번호';
COMMENT ON COLUMN TBL_CLASS.ATTACHMENT_NO IS '첨부파일번호';
COMMENT ON COLUMN TBL_CLASS.CLASS_NAME IS '수업이름';
COMMENT ON COLUMN TBL_CLASS.CLASS_TYPE IS '수업종류';
COMMENT ON COLUMN TBL_CLASS.CLASS_CATEGORY IS '수업카테고리';
COMMENT ON COLUMN TBL_CLASS.CLASS_INTRO IS '수업소개문구3가지';
COMMENT ON COLUMN TBL_CLASS.CLASS_INTRODUCE IS '수업소개';
COMMENT ON COLUMN TBL_CLASS.CREATED_DATE IS '수업일시';
COMMENT ON COLUMN TBL_CLASS.CLASS_STATUS IS '수업상태';
COMMENT ON COLUMN TBL_CLASS.CLASS_APPROVAL IS '승인여부';
