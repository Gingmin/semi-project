...
@WebServlet("/member/registVerfication")
public class MemberRegistVerificationNumberServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			msg.setContent(multipart, "text/html; charset=UTF-8");    //메일 내용
			
			/* Transport는 메일을 최종적으로 보내는 클래스로 메일을 보내는 부분 */
			if(isSuccess) {
				Transport.send(msg);
				System.out.println("가입 인증 메일 발송 성공!");
			}
