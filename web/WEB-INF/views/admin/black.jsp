					...
					<div class="col-sm-12">
						...
						<div class="table-responsive">
							<table class="table">
								<thead>
									<tr>
										...
										<th class="border-top-0">제재이력번호</th>
										<th class="border-top-0">제재시작일자</th>
										<th class="border-top-0">제재종료일자</th>
									</tr>
								</thead>
								<tbody id="detailMember">
									<c:forEach var="black" items="${ requestScope.blackList }">
									<tr>
										<td><c:out value="${ black.no }"/></td>
										<td><c:out value="${ black.email }"/></td>
										<td><c:out value="${ black.name }"/></td>
										<td><c:out value="${ black.phone }"/></td>
										<td><c:out value="${ black.enrollDate }"/></td>
										<td><c:out value="${ black.modifiedDate }"/></td>
										<td><c:out value="${ black.blackStatus }"/></td>
										<td><c:out value="${ black.role }"/></td>
										<td><c:out value="${ black.status }"/></td>
										<td><c:out value="${ black.blackHistoryDTO.constraintNo }"/></td>
										<td><c:out value="${ black.blackHistoryDTO.startDate }"/></td>
										<td><c:out value="${ black.blackHistoryDTO.endDate }"/></td>
									</tr>
									</c:forEach>
								</tbody>
							</table>
							...
							<div class="pagingArea" align="center">
								...
								<script>
									const link = "${ pageContext.servletContext.contextPath }/admin/black";
									const searchLink = "${ pageContext.servletContext.contextPath }/admin/black/search";
								    	...
								    	for(let i = 0; i <$tdds.length; i++) {
								    		...
								    		$tdds[i].onmouseenter = function() {
								 		    ...
								 		    $tdds[i].onclick = function() {
								 				...
								 				location.href = "${ pageContext.servletContext.contextPath }/admin/black/detail?no=" + no;
								 			} 
								    	}
								    }
