			...
			<div class="notice_menu_area">
				<div class="row">
					<div class="menu_list col-sm-3">
						<a class="list_detail"
							href="http://kordzor.cafe24.com/semiproject/notice_borad.html">공지사항</a>
					</div>
					<div class="menu_list col-sm-3">
						<a class="list_detail"
							href="http://kordzor.cafe24.com/semiproject/notice_review.html">리뷰</a>
					</div>
					<div class="menu_list col-sm-3">
						<a class="list_detail on"
							href="http://kordzor.cafe24.com/semiproject/notice_report.html">신고
							내역</a>
					</div>
					<div class="menu_list col-sm-3">
						<a class="list_detail"
							href="http://kordzor.cafe24.com/semiproject/notice_question.html">자주
							묻는 질문</a>
					</div>
				</div>
			</div>
