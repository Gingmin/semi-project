	...
	<div class="container">
	   <div class="info_area">
	      ...
	      <div class="submit_reset">
	         	<input type="button" class="choice ch1" value="일반회원" onclick="location.href='http://127.0.0.1:8001/semi/views/login/loginMember.html'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	      ...
	      <form class="info" action="${ pageContext.servletContext.contextPath }/member/login" method="post">
	         ...
	         <br>
	          ...
	          <div class="info_item1">
	            ...
	            <input class="box_detail" type="password" name="password" placeholder="비밀번호를 입력하세요">
	         </div>
	         ...
	         <div class="info_item1">
	            <div class="guide">
	        	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	       			...
	       			|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	       			<a class="regist" href="../regist/searchMember.html">계정찾기</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	       			|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	       			<a class="regist" href="../regist/identifyId.html">비밀번호 찾기</a>
	            </div>
	         </div>
